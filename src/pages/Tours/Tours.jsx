        ...
        <Grid item xs={6}>
          <Box>
            ...
            <Typography>
              ...
              modern living style well harmonizing with traditional breath. Get
              ready to discover our local life by getting lost in the maze of
              streets and bustling atmosphere. You will definitely not regret
              it!
            </Typography>
      ...
      <Grid container spacing={4} className="tour-package">
        <Grid item xs={6}>
          <Box>
            ...
            <Typography>
              Hanoi street food is a fascinating combination of diverse flavours
              which will impress you at the very first try. Let’s take the
              chance to explore our culinary world and enjoy the local lifestyle
              with a food tour around the city!
            </Typography>
